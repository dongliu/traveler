...
exports["userkey"] = function tmpl_userkey() {
    return '<div class="control-group"><div class="control-label">User defined key</div><div class="controls"><input type="text" name="userkey" pattern="[a-zA-Z_0-9]{1,30}"/><span class="help-inline"> Keep the key brief and unique (letter, number, _ suggested)</span></div></div>';
};
