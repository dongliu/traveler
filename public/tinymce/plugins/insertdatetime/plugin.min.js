tinymce.PluginManager.add('insertdatetime', function(e) {
  function t(t, n) {
    ...
    return (
      ...
      (t = t.replace('%m', r(n.getMonth() + 1, 2))),
      (t = t.replace('%d', r(n.getDate(), 2))),
      (t = t.replace('%H', '' + r(n.getHours(), 2))),
      (t = t.replace('%M', '' + r(n.getMinutes(), 2))),
      (t = t.replace('%S', '' + r(n.getSeconds(), 2))),
      (t = t.replace('%I', '' + (((n.getHours() + 11) % 12) + 1))),
      (t = t.replace('%p', '' + (n.getHours() < 12 ? 'AM' : 'PM'))),
      (t = t.replace('%B', '' + e.translate(s[n.getMonth()]))),
      (t = t.replace('%b', '' + e.translate(a[n.getMonth()]))),
      (t = t.replace('%A', '' + e.translate(o[n.getDay()]))),
      (t = t.replace('%a', '' + e.translate(i[n.getDay()]))),
      (t = t.replace('%%', '%'))
    );
  }
  function n(n) {
    ...
    if (e.settings.insertdatetime_element) {
      var i;
      (i = /%[HMSIp]/.test(n) ? t('%Y-%m-%dT%H:%M') : t('%Y-%m-%d')),
        (r = '<time datetime="' + i + '">' + r + '</time>');
      var o = e.dom.getParent(e.selection.getStart(), 'time');
      if (o) return e.dom.setOuterHTML(o, r), void 0;
    }
    e.insertContent(r);
  }
  var r,
