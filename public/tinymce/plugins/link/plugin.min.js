tinymce.PluginManager.add('link', function(e) {
  ...
  function n(t) {
    ...
    function r(t) {
      ...
      return (
        e.settings.target_list ||
          n.push({ text: 'New window', value: '_blank' }),
    ...
    function o() {
      d && d.value(e.convertURL(this.value(), 'href')),
        c ||
          0 !== x.text.length ||
          this.parent()
            .parent()
    ...
    var u,
      ...
      m = e.dom;
    (u = g.getNode()),
      (s = m.getParent(u, 'a[href]')),
      (x.text = c = s
        ? s.innerText || s.textContent
        : g.getContent({ format: 'text' })),
      (x.href = s ? m.getAttrib(s, 'href') : ''),
      (x.target = s ? m.getAttrib(s, 'target') : ''),
      (x.rel = s ? m.getAttrib(s, 'rel') : ''),
      'IMG' == u.nodeName && (x.text = c = ' '),
      t &&
        (d = {
          type: 'listbox',
          label: 'Link list',
      ...
      e.settings.rel_list &&
        (h = { name: 'rel', type: 'listbox', label: 'Rel', values: i(x.rel) }),
