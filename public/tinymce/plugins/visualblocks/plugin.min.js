    ...
    (e.addCommand('mceVisualBlocks', function() {
      ...
      l ||
        ...
        e
          ...
          .appendChild(o)),
        e.on('PreviewFormats AfterPreviewFormats', function(s) {
          a &&
            c.toggleClass(
              e.getBody(),
              'mce-visualblocks',
        ...
        c.toggleClass(e.getBody(), 'mce-visualblocks'),
        (a = e.dom.hasClass(e.getBody(), 'mce-visualblocks')),
        t && t.active(c.hasClass(e.getBody(), 'mce-visualblocks')),
        e.fire('VisualBlocks');
    }),
