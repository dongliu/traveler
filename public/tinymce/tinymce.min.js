  ...
  r(l, [], function() {
          ...
          parse: function(t) {
            ...
            function p(t, n, r, i, o, a) {
              return (o = o || a)
                ...
                : ((n = f(n || r || i)),
                  !e.allow_script_urls &&
                  /(java|vb)script:/i.test(n.replace(/[\s\r\n]+/, ''))
                    ? ''
            ...
            if (t) {
              for (
                ...
                if (
                  ...
                  if (
                    !e.allow_script_urls &&
                    ('behavior' == g || /expression\s*\(/.test(v))
                  )
                    continue;
                  'font-weight' === g && '700' === v
                    ? (v = 'bold')
    ...
    r(d, [], function() {
      ...
      function n(e, t) {
        ...
        if (
          ...
          (o.pageX =
            e.clientX +
            ((d && d.scrollLeft) || (u && u.scrollLeft) || 0) -
            ((d && d.clientLeft) || (u && u.clientLeft) || 0)),
            (o.pageY =
              e.clientY +
              ((d && d.scrollTop) || (u && u.scrollTop) || 0) -
              ((d && d.clientTop) || (u && u.clientTop) || 0));
        }
        return (
    ...
    r(p, [f], function(e) {
      function t(n) {
        ...
        function d(e) {
          e ? ((M[U] = M[V]), (M[q] = M[W])) : ((M[V] = M[U]), (M[W] = M[q])),
            (M.collapsed = F);
        }
        function u(e) {
          a(e), c(e);
        ...
        function _(e, t, r) {
          var i, o;
          for (
            e ? ((M[V] = t), (M[W] = r)) : ((M[U] = t), (M[q] = r)), i = M[U];
            i.parentNode;
          ...
          o == i
            ? w(M[V], M[W], M[U], M[q]) > 0 && M.collapse(e)
            : M.collapse(e),
            (M.collapsed = x()),
        ...
        function E(e) {
          ...
          if (3 == M[V].nodeType) {
            if (
              ((n = M[V].nodeValue),
              (i = n.substring(M[W], M[q])),
              e != O &&
                ((o = M[V]),
                (c = M[W]),
                (d = M[q] - M[W]),
                0 === c && d >= o.nodeValue.length - 1
          ...
          if (3 == e.nodeType) {
            if (
              ...
              r
                ...
                : ((l = M[q]), (a = o.substring(0, l)), (s = o.substring(l))),
              i != O && (e.nodeValue = s),
              i == I)
            )
              return;
      ...
      return (
        (c.prototype = {
          ...
          select: function(t, n) {
            ...
            return e(
              t,
              r.get(n) || r.get(r.settings.root_element) || r.doc,
              []
            );
          },
          is: function(n, r) {
          ...
          add: function(e, t, n, r, i) {
            ...
            return this.run(e, function(e) {
              var a;
              return (
                (a = u(t, 'string') ? o.doc.createElement(t) : t),
                o.setAttribs(a, n),
                ...
                if ('string' == typeof t) {
                  (i = e.style),
                    ...
                    'opacity' === t &&
                      ...
                      (i.filter =
                        '' === n ? '' : 'alpha(opacity=' + 100 * n + ')'),
                    'float' == t &&
                      (t = 'cssFloat' in e.style ? 'cssFloat' : 'styleFloat');
                  try {
                    i[t] = n;
                  } catch (a) {}
                  r.settings.update_styles &&
                ...
                if (null !== n)
                  switch (t) {
                    ...
                    case 'href':
                      i.keep_values &&
                        (i.url_converter &&
                          (n = i.url_converter.call(
                            i.url_converter_scope || r,
                            n,
                            t,
                            e
                          )),
          ...
          setOuterHTML: function(e, t, n) {
            ...
            return r.run(e, function(e) {
              function i() {
                var i, o;
                for (
                  o = n.createElement('body'), o.innerHTML = t, i = o.lastChild;
                  i;
          ...
          replace: function(e, t, n) {
            ...
            return r.run(t, function(t) {
              return (
                u(t, 'array') && (e = e.cloneNode(!0)),
                n &&
                  d(f(t.childNodes), function(t) {
                    e.appendChild(t);
                  }),
      ...
      function n() {
        ...
        (this.isDone = function(e) {
          ...
          (this.add = this.load = function(e, n, r) {
            ...
            i == f && (l.push(e), (s[e] = t)),
              n &&
                (c[e] || (c[e] = []), c[e].push({ func: n, scope: r || this }));
          }),
        ...
        (r.prototype = {
          ...
          load: function(n, o, a, s) {
            ...
            var c = this,
              d = o;
            c.urls[n] ||
              ('object' == typeof o && (d = o.prefix + o.resource + o.suffix),
              0 !== d.indexOf('/') &&
                -1 == d.indexOf('://') &&
                (d = r.baseURL + '/' + d),
              (c.urls[n] = d.substring(0, d.lastIndexOf('/'))),
              c.lookup[n] ? l() : e.ScriptLoader.add(d, l, s));
          },
        }),
      ...
      function n(e) {
        ...
        return r[e]
          ...
          : ((s = t('id accesskey class dir lang style tabindex title')),
            ...
            n('li', 'value', u),
            n('dl', '', 'dt dd'),
            n('a', 'href target rel media hreflang type', d),
            n('q', 'cite', d),
            ...
            'html4' != e &&
              ...
              n('output', 'for form name', d),
              n('progress', 'value max', d),
              n('meter', 'value min max low high optimum', d),
        ...
        function u(e) {
          ...
          if (e)
            for (
              e = t(e, ','),
                v['@'] &&
                  ((w = v['@'].attributes), (_ = v['@'].attributesOrder)),
                n = 0,
                r = e.length;
              r > n;
              n++
                    ...
                    if ((s = S.exec(f[o]))) {
                      ...
                      C &&
                        ('=' === C &&
                          ...
                          c.attributesDefault.push({ name: m, value: E }),
                          (u.defaultValue = E)),
                        ':' === C &&
                          ((c.attributesForced = c.attributesForced || []),
                          c.attributesForced.push({ name: m, value: E }),
                          (u.forcedValue = E)),
                        '<' === C && (u.validValues = i(E, '?'))),
                        T.test(m)
                          ? ((c.attributePatterns = c.attributePatterns || []),
                            (u.pattern = d(m)),
                            c.attributePatterns.push(u))
                          : (g[m] || y.push(m), (g[m] = u));
                    }
                w || '@' != p || ((w = g), (_ = y)),
        ...
        (i = i || {}),
          ...
          (a.parse = function(e) {
            ...
            function a(e, t, n, r, o) {
              ...
              (W[t] &&
                !i.allow_script_urls &&
                /(java|vb)script:/i.test(
                  decodeURIComponent(n.replace(l, ''))
                )) ||
            ...
            for (
              M = new RegExp(
                ...
                D = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g,
                b = o.getShortEndedElements(),
                L = i.self_closing_elements || o.getSelfClosingElements(),
                C = o.getBoolAttrs(),
                w = i.validate,
                y = i.remove_internals,
                z = i.fix_self_closing,
                P = o.getSpecialElements();
              (l = M.exec(e));

            ) {
              if (
                (c < l.index && s.text(F(e.substr(c, l.index - c))), (d = l[6]))
              )
                (d = d.toLowerCase()),
                ...
                if (
                  ...
                  z &&
                    ...
                    f[f.length - 1].name === d &&
                    r(d),
                  !w || (_ = o.getElementRule(d)))
                ) {
                  if (
                    ((N = !0),
                    w && ((S = _.attributes), (T = _.attributePatterns)),
                    (k = l[8])
                    ...
                    if (
                      ((R = _.attributesRequired),
                      (A = _.attributesDefault),
                      (B = _.attributesForced),
                      (H = _.removeEmptyAttrs),
                      H && !p.length && (N = !1),
                      B)
                    )
                      for (m = B.length; m--; )
                ...
                if ((u = P[d])) {
                  (u.lastIndex = c = l.index + l[0].length),
                    (l = u.exec(e))
                      ? (N && (h = e.substr(c, l.index - c)),
                        (c = l.index + l[0].length))
                      : ((h = e.substr(c)), (c = e.length)),
            ...
            for (
              c < e.length && s.text(F(e.substr(c))), m = f.length - 1;
              m >= 0;
              m--
            )
          ...
          for (
            ...
            if (((r = t[n]), r.parent && !r.fixed))
              if (g[r.name] && 'li' == r.parent.name) {
                ...
                if (o && a.length > 1) {
                  for (
                    a.reverse(), s = c = d.filterNode(a[0].clone()), p = 0;
                    p < a.length - 1;
                    p++
                  ) {
                    for (
                      l.isValidChild(c.name, a[p].name)
                        ? ((u = d.filterNode(a[p].clone())), c.append(u))
                        : (u = c),
                        f = a[p].firstChild;
                      f && f != a[p + 1];
                  ...
                  l.isValidChild('div', r.name)
                    ? r.wrap(d.filterNode(new e('div', 1)))
                    ...
                    if ((r = S ? l.getElementRule(t) : {})) {
                      ...
                      if (
                        ...
                        if (r.paddEmpty)
                          ...
                          return (
                            (a = b.parent), b.empty().remove(), (b = a), void 0
                          );
                      b = b.parent;
                    }
                  },
              ...
              for (o.body = 1, n = 0; r > n; n++)
                if (
                  ...
                  for (u = i.prev; u; ) {
                    if (
                      ((f = u.name),
                      'span' !== f || 'bookmark' !== u.attr('data-mce-type'))
                    ) {
                      if ('br' !== f) break;
                      if ('br' === f) {
                        i = null;
                  ...
                  for (
                    ...
                    c = c.parent;
                  d === c &&
                    ((m = new e('#text', 3)), (m.value = '\xa0'), i.replace(m));
                }
            }),
          r.allow_html_in_named_anchor ||
            d.addAttributeFilter('id,name', function(e) {
              ...
              if (n) n(e);
                ...
                if (
                  ...
                  for (
                    ...
                    (d = h.attributesOrder[p]),
                      d in c.map &&
                        ((u = c.map[d]),
                        (f.map[d] = u),
                        f.push({ name: d, value: u }));
          ...
          f.addNodeFilter('script,style', function(e, t) {
            ...
            for (var r = e.length, i, o; r--; )
              if (
                ...
                var a = (i.attr('type') || 'text/javascript').replace(
                  /^mce\-/,
                  ''
                );
          ...
          if (
            ...
            for (s = f.children, o = s.length - 1; o >= i; )
              if (
                ...
                (u = r.compareEndPoints(n ? 'StartToStart' : 'EndToEnd', t)),
                u > 0)
              )
                o = d - 1;
              else {
              ...
              (a = i.create('a')),
                ...
                3 == t.nodeType
                  ? (t.parentNode.insertBefore(a, t),
                    u.moveToElementText(a),
                    u.moveStart('character', n),
                    i.remove(a),
                    r.setEndPoint(e ? 'StartToStart' : 'EndToEnd', u))
                  : ((m = t.childNodes),
                    m.length
                      ? (n >= m.length
      ...
      return function(r, i) {
        ...
        function a(t) {
          ...
          (n = t.screenX - k),
            ...
            (D = 5 > D ? 5 : D),
            (e.modifierPressed(t) ||
              ('IMG' == x.nodeName && 0 !== N[2] * N[3])) &&
              ((M = Math.round(D / H)), (D = Math.round(M * H))),
            b.setStyles(w, { width: M, height: D }),
            N[2] < 0 &&
              w.clientWidth <= M &&
              b.setStyle(w, 'left', T + (A - M)),
            N[3] < 0 &&
              w.clientHeight <= D &&
              b.setStyle(w, 'top', R + (B - D)),
            L ||
        ...
        function s() {
          ...
          (L = !1),
            ...
            i.fire('ObjectResized', { target: x, width: M, height: D }),
            i.nodeChanged();
        }
        function l(e, t, n) {
          var r,
          ...
          (r = b.getPos(e, p)),
            ...
            x != e && (h(), (x = e), (M = D = 0)),
            (u = i.fire('ObjectSelected', { target: e })),
            o(e) && !u.isDefaultPrevented()
              ? C(_, function(e, r) {
                  function o(t) {
                    (L = !0),
                      (k = t.screenX),
                      ...
                      b.bind(P, 'mouseup', s),
                      O != P &&
                        (b.bind(O, 'mousemove', a), b.bind(O, 'mouseup', s));
                  }
                  var c, u;
                  return t
                    ? (r == t && o(n), void 0)
                      ...
                      c
                        ...
                        : ((u = i.getBody()),
                          (c = b.add(u, 'div', {
                            ...
                            unSelectabe: !0,
                            style:
                              'cursor:' + r + '-resize; margin:0; padding:0',
                          })),
        ...
        (a.prototype = {
          ...
          getBookmark: function(e, t) {
            ...
            if (
              ...
              if (l.item)
                return (
                  (p = l.item(0)), (f = p.nodeName), { name: f, index: n(f, p) }
                );
              c = l.duplicate();
              try {
                l.collapse(),
              ...
              (c = r(l.cloneRange())),
                u ||
                  ...
                  c.insertNode(
                    a.create(
                      'span',
                      { 'data-mce-type': 'bookmark', id: d + '_end', style: h },
                      m
                    )
                  )),
                (l = r(l)),
                ...
                l.insertNode(
                  a.create(
                    'span',
                    { 'data-mce-type': 'bookmark', id: d + '_start', style: h },
                    m
                  )
                );
            }
          ...
          moveToBookmark: function(e) {
            ...
            function n(t) {
              ...
              if (
                ...
                ((r = n.parentNode),
                'start' == t
                  ? (d ? ((r = n.firstChild), (i = 1)) : (i = o.nodeIndex(n)),
                    (f = p = r),
                    (m = h = i))
                  : (d ? ((r = n.firstChild), (i = 1)) : (i = o.nodeIndex(n)),
                    (p = r),
            ...
            function r(t, n) {
              ...
              do {
                if (3 == t.nodeType && 0 !== c(t.nodeValue).length)
                  return (
                    n ? a.setStart(t, 0) : a.setEnd(t, t.nodeValue.length),
                    void 0
                  );
                if (l[t.nodeName])
                  return (
              ...
              'BODY' == r.nodeName &&
                (n ? a.setStart(r, 0) : a.setEnd(r, r.childNodes.length));
            }
            var i = this,
              o = i.dom,
              a = o.createRng(),
              ...
              l;
            if (
              ((i.lastFocusBookmark = null),
              (l = o.schema.getNonEmptyElements()),
              t)
            ) {
          ...
          getRng: function(e) {
            ...
            return (
              ...
              t.selectedRange &&
                t.explicitRange &&
                (0 ===
                  r.compareBoundaryPoints(r.START_TO_START, t.selectedRange) &&
          ...
          normalize: function() {
            function t(t) {
              ...
              function l(t, n) {
                ...
                for (
                  n = n || c,
                    r = new e(n, f.getParent(n.parentNode, f.isBlock) || p);
                  (m = r[t ? 'prev' : 'next']());
              ...
              if (
                ...
                (d = r[(t ? 'start' : 'end') + 'Offset']),
                (h = f.schema.getNonEmptyElements()),
                9 === c.nodeType && ((c = f.getRoot()), (d = 0)),
                c === p)
              ) {
                if (
                  t &&
                  ((m = c.childNodes[d > 0 ? d - 1 : 0]),
                  m &&
      ...
      function t(e) {
        (this.walk = function(t, r) {
          ...
          if (
            ...
            1 == d.nodeType &&
              d.hasChildNodes() &&
              (d = d.childNodes[Math.min(u - 1, d.childNodes.length - 1)]),
            l == d)
          )
            return r(i([l]));
      ...
      return function(r) {
        ...
        function u(e) {
          ...
          return (
            r.dom.getParent(e, function(e) {
              return (
                (t = r.dom.getStyle(e, 'text-decoration')), t && 'none' !== t
              );
            }),
            t
          );
            ...
            return (
              ...
              0 >= a || (a > l && c > a)
                ...
                : ((d = I.clone(n, K)),
                  ...
                  a > l
                    ? e.insertBefore(d, s)
                    : l > a && e.insertBefore(d, s.nextSibling),
                  r.push(d),
                  et(o, function(e) {
                    d.appendChild(e);
                  }),
                ...
                function p(e) {
                  ...
                  return (
                    ...
                    w(y, 'br')
                      ...
                      : h.wrapper && g(e, t, n)
                      ? ((v = 0), void 0)
                      : f && !_ && h.block && !h.wrapper && i(y) && W(C, c)
        ...
        function m(e, t, n) {
          ...
          function d(e) {
            ...
            return (
              H(n) && (n = n[e ? 'firstChild' : 'lastChild']),
              I.remove(t, !0),
              n
            );
          }
        ...
        function g(e, t, n, r) {
          ...
          if (o && e)
            for (s = 0; s < o.length; s++)
              if (
                ((a = o[s]),
                x(e, a) && i(e, a, 'attributes') && i(e, a, 'styles'))
              ) {
                if ((l = a.classes))
        ...
        function v(e, t, n) {
          ...
          return n
            ? r(n)
            : ((n = F.getNode()),
              r(n) ? Y : ((i = F.getStart()), i != n && r(i) ? Y : K));
        }
        function y(e, t) {
          var n,
            r = [],
        ...
        function T(t, n, a) {
          function s(e) {
            ...
            if (
              ...
              (s = I.getRoot()),
              3 == r.nodeType && !k(r) && (e ? v > 0 : b < r.nodeValue.length))
            )
              return r;
            for (;;) {
              if (!n[0].block_expand && V(i)) return i;
              for (o = i[a]; o; o = o[a]) if (!H(o) && !k(o) && !t(o)) return i;
              if (i.parentNode == s) {
                r = i;
                break;
              }
          ...
          function d(t, n, i) {
            ...
            return d
              ? ((n = i ? 0 : d.length), { container: d, offset: n })
              : void 0;
          }
          function u(e, r) {
            var i, a, s, l;
          ...
          function f(e, t) {
            ...
            if (
              ...
              r ||
                (r = I.getParent(3 == e.nodeType ? e.parentNode : e, function(
                  e
                ) {
                  return e != a && i(e);
                })),
            ...
            for (
              et(e.styles, function(e, i) {
                ...
                et(e.classes, function(e) {
                  (e = E(e, t)),
                    (!r || I.hasClass(r, e)) && I.removeClass(n, e);
                }),
                o = I.getAttribs(n),
                i = 0;
              i < o.length;
              ...
              ? i == I.getRoot() &&
                ((t.list_block && w(e, t.list_block)) ||
                  et(tt(e.childNodes), function(e) {
                    W(U, e.nodeName.toLowerCase())
                      ? o
                        ? o.appendChild(e)
                        : ((o = S(e, U)),
                          I.setAttribs(o, r.settings.forced_root_block_attrs))
                      : (o = 0);
                  }))
              : V(e) &&
                !V(i) &&
    ...
    r(H, [h, f], function(e, t) {
      ...
      return (
        ...
        function(t) {
          function i() {
            return n(
              t.getContent({ format: 'raw', no_events: 1 }).replace(r, '')
            );
          }
          function o() {
            (a.typing = !1), a.add();
              ...
              ((r >= 33 && 36 >= r) ||
                ...
                d &&
                  ...
                  (t.isDirty() ||
                    ...
                    t.isNotDirty ||
                      t.fire('change', { level: l[0], lastLevel: null })),
                  t.fire('TypingUndo'),
                  (d = !1),
                  t.nodeChanged());
            }),
            t.on('KeyDown', function(e) {
              ...
              return (t >= 33 && 36 >= t) || (t >= 37 && 40 >= t) || 45 == t
                ...
                : ((16 > t || t > 20) &&
                    ...
                    91 != t &&
                    !a.typing &&
                    (a.beforeChange(), (a.typing = !0), a.add(), (d = !0)),
                  void 0);
            }),
            ...
            (a = {
              ...
              add: function(e) {
                ...
                if (
                  ...
                  (e.content = i()),
                  u ||
                    t.fire('BeforeAddUndo', { level: e }).isDefaultPrevented())
                )
                  return null;
                if (((o = l[s]), o && o.content == e.content)) return null;
                if (
                  (l[s] && (l[s].beforeBookmark = c),
                  r.custom_undo_redo_levels &&
                    l.length > r.custom_undo_redo_levels)
                ) {
        ...
        function r(r) {
          ...
          function m(e) {
            ...
            t &&
              ...
              i.setAttribs(e, a.forced_root_block_attrs);
          }
          function h(e) {
            var t = S,
              r,
          ...
          function g(t) {
            ...
            if (
              'TABLE' === S.nodeName ||
              (S.previousSibling && 'TABLE' == S.previousSibling.nodeName)
            )
              return (I && !t) || (!I && t);
            for (
              n = new e(S, R),
          ...
          function v(e, n) {
            ...
            if (
              ...
              (u = t.getBody().nodeName.toLowerCase()),
              !o || !d(o))
            ) {
              ...
              if (a && l.isValidChild(u, f.toLowerCase())) {
                for (
                  r = i.create(f), m(r), a.parentNode.insertBefore(r, a), s = a;
                  s && !i.isBlock(s);
          ...
          function y() {
            ...
            /^(OL|UL|LI)$/.test(n) && (O = 'LI'),
              ...
              e(!0) && e()
                ...
                ? 'LI' == n
                  ? (i.insertAfter(H, t()),
                    H.appendChild(i.doc.createTextNode(' ')),
                    H.appendChild(M))
                  : M.parentNode.insertBefore(H, M)
                : e()
                ? (i.insertAfter(H, t()), u(H))
                : ((M = t()),
                  (E = N.cloneRange()),
                  E.setStartAfter(R),
                  E.setEndAfter(M),
                  (L = E.extractContents()),
                  'LI' == O && 'LI' == L.firstChild.nodeName
                    ? ((H = L.firstChild), i.insertAfter(L, M))
                    : (i.insertAfter(L, M), i.insertAfter(H, M))),
              i.remove(R),
              p(H),
              s.add();
          }
          ...
          function C() {
            ...
            S &&
              ...
              i.remove(r),
              t
                ? (N.setStartBefore(e), N.setEndBefore(e))
                : (N.setStartAfter(e), N.setEndAfter(e)),
              o.setRng(N),
              s.add();
          }
          function x(e) {
          ...
          if (
            ...
            ((S = N.startContainer),
            (T = N.startOffset),
            (O = (a.force_p_newlines ? 'p' : '') || a.forced_root_block),
            (O = O ? O.toUpperCase() : ''),
            (A = i.doc.documentMode),
            (B = r.shiftKey),
            1 == S.nodeType &&
              S.hasChildNodes() &&
              ((I = T > S.childNodes.length - 1),
              (S = S.childNodes[Math.min(T, S.childNodes.length - 1)] || S),
              (T = I && 3 == S.nodeType ? S.nodeValue.length : 0)),
            (k = w(S)))
          ) {
            ...
            if (
              (((O && !B) || (!O && B)) && (S = v(S, T)),
              (R = i.getParent(S, i.isBlock)),
              (M = R ? i.getParent(R.parentNode, i.isBlock) : null),
              (D = R ? R.nodeName.toUpperCase() : ''),
              (P = M ? M.nodeName.toUpperCase() : ''),
              'LI' != P || r.ctrlKey || ((R = M), (D = P)),
              'LI' == D)
            ) {
            ...
            (O && R === t.getBody()) ||
              ...
              g()
                ? ((H =
                    /^(H[1-6]|PRE|FIGURE)$/.test(D) && 'HGROUP' != P
                      ? h(O)
                      : h()),
                  a.end_container_on_empty_block && d(M) && i.isEmpty(R)
                    ? (H = i.split(M, R))
                    : i.insertAfter(H, R),
                  p(H))
                : g(!0)
                ? ((H = R.parentNode.insertBefore(h(), R)), u(H), p(R))
                : ((E = N.cloneRange()),
                  E.setEndAfter(R),
                  (L = E.extractContents()),
                  x(L),
      ...
      return function(n) {
        ...
        o(this, {
          ...
          h({
            ...
            mceCleanup: function() {
              var e = w.getBookmark();
              n.setContent(n.getContent({ cleanup: u }), { cleanup: u }),
                w.moveToBookmark(e);
            },
            ...
            mceInsertContent: function(t, r, i) {
              ...
              /^ | $/.test(i) && (i = o(i)),
                ...
                (i = i.replace(/\{\$caret\}/, v));
              var y = n.getBody();
              x.isBlock(y.firstChild) &&
                x.isEmpty(y.firstChild) &&
                (y.firstChild.appendChild(x.doc.createTextNode('\xa0')),
                w.select(y.firstChild, !0),
                x.remove(y.firstChild.lastChild)),
              ...
              (p = x.get('mce_marker')),
                ...
                (h = p.previousSibling),
                h && 3 == h.nodeType
                  ? (m.setStart(h, h.nodeValue.length),
                    d ||
                      ((g = p.nextSibling),
                      g &&
                        3 == g.nodeType &&
                        (h.appendData(g.data), g.parentNode.removeChild(g))))
                  : (m.setStartBefore(p), m.setEndBefore(p)),
                x.remove(p),
                w.setRng(m),
                n.fire('SetContent', f),
                n.addVisual();
        ...
        (t.prototype = {
          ...
          toAbsolute: function(e, n) {
            return (
              ...
              e.getURI(
                this.host == e.host && this.protocol == e.protocol ? n : 0
              )
            );
          },
    ...
    r(W, [O, f, F, z], function(e, t, n, r) {
      var i = t.makeMap(
        ...
        s = !1,
        l = e.extend({
          Statics: { controlIdLookup: {}, elementIdCache: o },
          isRtl: function() {
            return l.rtl;
          },
          classPrefix: 'mce-',
          ...
          fire: function(e, t, n) {
            ...
            if (
              ...
              for (
                a = 0, s = l.length;
                s > a &&
                (t.isImmediatePropagationStopped() || l[a].call(o, t) !== !1);
                a++
              );
            if (n !== !1)
          ...
          bindPendingEvents: function() {
            ...
            if (((o._rendered = !0), (f = o._nativeEvents))) {
              for (
                d = o.parents().toArray(), d.unshift(o), l = 0, c = d.length;
                !u && c > l;
                l++
              )
                u = d[l]._eventsRoot;
              ...
              for (p in f) {
                ...
                'wheel' !== p || s
                  ? ('mouseenter' === p || 'mouseleave' === p
                      ? u._hasMouseEnter ||
                        (r.on(u.getEl(), 'mouseleave', t),
                        r.on(u.getEl(), 'mouseover', n),
                        (u._hasMouseEnter = 1))
                      : u[p] || (r.on(u.getEl(), p, e), (u[p] = !0)),
                    (f[p] = !1))
                  : a
        ...
        d = e.extend({
          ...
          init: function(e) {
            ...
            u._super(e),
              ...
              u.on('postrender show', function(e) {
                if (e.control == u) {
                  ...
                  u.modal &&
                    ...
                    (n = n.firstChild),
                    u.getContainerElm().appendChild(n),
                    setTimeout(function() {
              ...
              e.popover &&
                ((u._preBodyHtml =
                  '<div class="' + u.classPrefix + 'arrow"></div>'),
                u
                  .addClass('popover')
                  .addClass('bottom')
                  .addClass(u.isRtl() ? 'end' : 'start'));
          },
          fixed: function(e) {
            var t = this;
            if (t._fixed != e) {
        ...
        function n() {
          if (!m)
            if (((m = []), u.find))
              ...
              for (
                var e = u.getEl().getElementsByTagName('*'), t = 0;
                t < e.length;
                t++
              )
          ...
          setTimeout(function() {
            ...
            e.find('*').each(function(e) {
              e.canFocus &&
                ...
                'filepicker' == e.type
                  ? (t.push(e.getEl('inp')),
                    e.getEl('open') && t.push(e.getEl('open')))
                  : t.push(e.getEl()));
            }),
            e.statusbar &&
      ...
      return function(a) {
        ...
        function d() {
          function t(e) {
            ...
            if (
              ...
              3 == l.nodeType &&
                ((r = z.getParent(n.startContainer, z.isBlock)),
                e && (r = z.getNext(r, z.isBlock)),
                !r ||
                  (!t() && n.collapsed) ||
                  ((i = z.create('em', { id: '__mceDel' })),
        ...
        function u() {
          function e(e) {
            var t = z.create('body'),
              n = e.cloneContents();
            return (
              t.appendChild(n), W.serializer.serialize(t, { format: 'html' })
            );
          }
          function t(t) {
            var n = e(t),
          ...
          a.on('keydown', function(e) {
            ...
            if (!c(e) && (n == F || n == I)) {
              if (
                ((r = a.selection.isCollapsed()), r && !z.isEmpty(a.getBody()))
              )
                return;
              if ($ && !r) return;
        ...
        function p() {
          a.settings.content_editable ||
            (z.bind(a.getDoc(), 'focusin', function() {
              W.setRng(W.getRng());
            }),
          ...
          a.on('click', function(e) {
            (e = e.target),
              /^(IMG|HR)$/.test(e.nodeName) &&
                W.getSel().setBaseAndExtent(e, 0, e, 1),
              'A' == e.nodeName &&
                z.hasClass(e, 'mce-item-anchor') &&
                W.select(e),
              a.nodeChanged();
          });
        }
        function v() {
          ...
          function t() {
            return (
              !W.isCollapsed() &&
              z.getParent(W.getStart(), z.isBlock) !=
                z.getParent(W.getEnd(), z.isBlock)
            );
          }
        ...
        function x() {
          l() > 7 ||
            ...
            z.addClass(a.getBody(), 'mceHideBrInPre'),
          ...
          a.on('keydown', function(t) {
            ...
            if (
              ...
              (u = a.schema.getNonEmptyElements()),
                t.preventDefault(),
                (s = z.create('br', { id: '__tmp' })),
                i.parentNode.insertBefore(s, i),
                a
                  .getDoc()
                  .execCommand(n ? 'ForwardDelete' : 'Delete', !1, null),
        ...
        function A() {
          ...
          l() >= 10 &&
            ((e = ''),
            O('p div h1 h2 h3 h4 h5 h6'.split(' '), function(t, n) {
              e += (n > 0 ? ',' : '') + t + ':empty';
            }),
        ...
        C(),
          ...
          u(),
          L(),
          K && (_(), d(), p(), g(), S(), i.iOS ? (y(), D()) : f()),
          $ && i.ie < 11 && (m(), b(), x(), w(), R(), A(), B(), H()),
          i.ie >= 11 && P(),
          j && (m(), h(), v(), E(), k(), T(), M());
      };
    }),
      ...
      return {
        fire: function(e, i, o) {
          ...
          if (
            ...
            for (
              l = 0, c = s.length;
              c > l && ((s[l] = d = s[l]), !i.isImmediatePropagationStopped());
              l++
            )
    ...
    r(
      rt,
      [g, y, b, E, N, R, B, H, L, M, D, P, v, d, Z, C, w, et, h, f, tt, nt],
      function(
        e,
        n,
        r,
        ...
        return (
          (N.prototype = {
              ...
              if (n.getElement() && b.contentEditable) {
                ...
                a &&
                  ...
                  r.hidden_input &&
                    ...
                    (E.insertAfter(
                      E.create('input', { type: 'hidden', name: i }),
                      i
                    ),
                    (n.hasHiddenInput = !0)),
                  ...
                  E.bind(a, 'submit reset', n.formEventDelegate),
                  n.on('reset', function() {
            ...
            init: function() {
                ...
                n.render_ui &&
                  ...
                  'function' != typeof n.theme
                    ? ((i = n.width || r.style.width || r.offsetWidth),
                      ...
                      f.test('' + i) &&
                        (i = Math.max(
                          parseInt(i, 10) + (l.deltaWidth || 0),
                          100
                        )),
                      f.test('' + o) &&
                        (o = Math.max(
                          parseInt(o, 10) + (l.deltaHeight || 0),
                          a
                        )),
                      (l = t.theme.renderUI({
                        targetNode: r,
                      ...
                      n.content_editable ||
                        (E.setStyles(l.sizeContainer || l.editorContainer, {
                          wi2dth: i,
                          h2eight: o,
                        }),
                        (o =
              ...
              if (
                (document.domain != location.hostname && (c = g),
              ...
              (t.contentAreaContainer = l.iframeContainer),
                l.editorContainer &&
                  (E.get(l.editorContainer).style.display = t.orgDisplay),
            ...
            initContentBody: function(t) {
              ...
              o.inline || (n.getElement().style.visibility = n.orgVisibility),
                ...
                o.content_editable &&
                  ...
                  E.addClass(f, 'mce-content-body'),
                  (f.tabIndex = -1),
                  (n.contentDocument = p = o.content_document || document),
                  (n.contentWindow = o.content_window || window),
                  (n.bodyElement = f),
                  (o.content_document = o.content_window = null),
                  (o.root_name = f.nodeName.toLowerCase())),
                (m = n.getBody()),
                (m.disabled = !0),
                o.readonly ||
                  (n.inline &&
                    'static' == E.getStyle(m, 'position', !0) &&
                ...
                n.parser.addNodeFilter('script', function(e) {
                  for (var t = e.length, n; t--; )
                    (n = e[t]),
                      n.attr(
                        'type',
                        'mce-' + (n.attr('type') || 'text/javascript')
                      );
                }),
                ...
                n.parser.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function(e) {
                  for (
                    var t = e.length, i, o = n.schema.getNonEmptyElements();
                    t--;

                  )
                    (i = e[t]),
                      i.isEmpty(o) &&
                        (i.empty().append(new r('br', 1)).shortEnded = !0);
                }),
                ...
                o.browser_spellcheck ||
                  o.gecko_spellcheck ||
                  ((p.body.spellcheck = !1),
                  E.setAttrib(m, 'spellcheck', 'false')),
                n.fire('PostRender'),
                (n.quirks = y(n)),
                ...
                (n.initialized = !0),
                R(n._pendingNativeEvents, function(e) {
            ...
            focus: function(e) {
              ...
              e ||
                ...
                (D || i) &&
                  ((l = n.getBody()),
                  l.setActive && b.ie < 11 ? l.setActive() : l.focus(),
                  i && r.normalize()),
                a &&
                  a.ownerDocument == s &&
                ...
                0 === e.length || /^\s+$/.test(e)
                  ? ((i = n.settings.forced_root_block),
                    ...
                    n.schema.isValidChild(
                      ...
                      ? ((e = P && 11 > P ? '' : '<br data-mce-bogus="1">'),
                        (e = n.dom.createHTML(
                          i,
                          n.settings.forced_root_block_attrs,
                          e
                        )))
                      : (!P || 11 > P) && (e = '<br data-mce-bogus="1">'),
                    (r.innerHTML = e),
                    n.fire('SetContent', t))
                  : ('raw' !== t.format &&
            ...
            getContainer: function() {
              ...
              return (
                e.container ||
                  (e.container = E.get(e.editorContainer || e.id + '_parent')),
                e.container
              );
            },
              ...
              if (!e.removed) {
                ...
                P && t && t.execCommand('SelectAll'),
                  ...
                  e.settings.content_editable ||
                    (M.unbind(e.getWin()), M.unbind(e.getDoc()));
              ...
              if (!t.destroyed) {
                ...
                e &&
                  ...
                  n &&
                    ...
                    E.unbind(n, 'submit reset', t.formEventDelegate)),
        ...
        function s(s) {
          ...
          c.on('init', function() {
            'onbeforedeactivate' in document && t.ie < 11
              ...
              : (c.inline || t.ie > 10) &&
                ...
                t.webkit &&
                  ...
                  e.DOM.bind(document, 'selectionchange', u),
            ...
            c.on('focusout', function() {
              (c.selection.lastFocusBookmark = o(d)),
        ...
        h = {
          ...
          init: function(t) {
            ...
            function o() {
              ...
              if (t.selector)
                return (
                  u(c.select(t.selector), function(r) {
                    var i = new e(n(r), t, a);
                    s.push(i), i.render(1);
                  }),
                  void 0
                ...
                case 'exact':
                  (m = t.elements || ''),
                    m.length > 0 &&
                      u(d(m), function(n) {
                        c.get(n)
                          ? ((l = new e(n, t, a)), s.push(l), l.render(!0))
                          : u(document.forms, function(r) {
                  ...
                  u(c.select('textarea'), function(r) {
                    (t.editor_deselector && i(r, t.editor_deselector)) ||
                      ((!t.editor_selector || i(r, t.editor_selector)) &&
                        ((l = new e(n(r), t, a)), s.push(l), l.render(!0)));
                  });
              }
              t.oninit &&
                ((m = h = 0),
          ...
          remove: function(e) {
              ...
              o;
            {
              if (e) {
                ...
                return (
                  t.activeEditor == i && (t.activeEditor = r[0]),
                  o && t.fire('RemoveEditor', { editor: i }),
    ...
    r(ft, [], function() {
      ...
      function n() {
        function n(e) {
          var n, r;
          return (
            (r = e !== t ? d + e : i.indexOf(',', d)),
            -1 === r || r > i.length
              ? null
              : ((n = i.substring(d, r)), (d = r + 1), n)
          );
        }
        var r,
          i,
          ...
          n._super(e),
            ...
            e.placeholder &&
              ...
              n.on('focusout', function() {
                0 === n.value().length &&
                  ((n.getEl('inp').value = e.placeholder),
                  n.addClass('placeholder'));
              }));
        },
        value: function(e) {
          ...
          if (
            ...
            for (
              C = u / d,
                ...
                0 === d &&
                  ('end' == l
                    ? (w = u + o[T])
                    : 'center' == l
                    ? ((w = Math.round(i[R] / 2 - (i[R] - u) / 2) + o[T]),
                      0 > w && (w = o[T]))
                    : 'justify' == l &&
                      ((w = o[T]), (c = Math.floor(u / (r.length - 1))))),
                x[L] = o[I],
                t = 0,
                n = r.length;
              n > t;
              ...
              (p = r[t]),
                ...
                (y = m.maxFlexSize || m[E]),
                'center' === s
                  ? (x[L] = Math.round(i[M] / 2 - m[D] / 2))
                  : 'stretch' === s
                  ? ((x[D] = V(m[P] || 0, i[M] - o[I] - o[F])), (x[L] = o[I]))
                  : 'end' === s && (x[L] = i[M] - m[D] - o.top),
              ...
              if (e.control == this)
                for (; n; ) {
                  if (
                    ...
                    return (
                      e.stopImmediatePropagation(), t.call(this, e), void 0
                    );
                  n = n.parentNode;
                }
            }),
        ...
        (n.show = function(i) {
          return (
            ...
            window.setTimeout(function() {
              r &&
                t.appendChild(
                  e.createFragment('<div class="mce-throbber"></div>')
                );
            }, i || 0),
            n
          );
