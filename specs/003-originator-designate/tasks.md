...
- [ ] T014b [P] Extend `e2e/us-originator-designate.spec.js` (once Phase 3/US2 is implemented) with the remaining scenarios T014 originally specified: dashboard visibility for the Designate, ISSUANCE email recipiency, Designate-performed closure with closure-record identity verification, FINAL NCR DISTRIBUTION recipiency, and cross-NCR access denial
