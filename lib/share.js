...
var { sendNotification } = require('./email');
...
function addUserFromAD(req, res, doc) {
  ...
  ldapClient.search(ad.searchBase, opts, false, function(err, result) {
    ...
    sendNotification({
      recipients: email,
      subject: 'New Traveler Shared',
      html: `A new Traveler has been shared with you.<br/>
Go to this link to start work: <br/>
