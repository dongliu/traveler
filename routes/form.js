...
module.exports = function(app) {
  ...
  app.put(
    ...
    async function releaseForm(req, res) {
      ...
      releasedForm.subsystem = reqUtils.sanitizeText(req.body.subsystem || '');
      releasedForm.device = reqUtils.sanitizeText(req.body.device || '');
      releasedForm.activity = reqUtils.sanitizeText(req.body.activity || '');
